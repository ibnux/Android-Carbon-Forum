...
//TODO change ExampleAPIAddress.java to APIAddress.java
public class ExampleAPIAddress
{
	public static final String WEBSITE_PATH = ""; //Website path, You can leave it blank in most cases.
	public static final String API_KEY = "4268"; //Application key you set in ```config.php```
	public static final String API_SECRET = "afssfsdfsdf"; //Application secret you set in ```config.php```
/*
    //Debug
...
*/
    ...
    //Real
    public static final String DOMAIN_NAME = "https://serangid.com" + WEBSITE_PATH; // Main domain name
    public static final String MOBILE_DOMAIN_NAME = "https://m.serangid.com" + WEBSITE_PATH; // Domain name of mobile version
    public static final String BASIC_API_URL = "https://app.serangid.com" + WEBSITE_PATH; // Domain name of API
